...
document.getElementById('nextToEnvelope').addEventListener('click', function(e) {
    e.preventDefault();
    console.log('Next button clicked - moving to envelope stage');
...
// Next to Drumroll
document.getElementById('nextToDrumroll').addEventListener('click', function(e) {
    e.preventDefault();
    console.log('Moving to drumroll stage');
    showStage('drumrollStage');
    
    // Auto-advance after drumroll
    setTimeout(() => {
        console.log('Auto-advancing to question stage');
